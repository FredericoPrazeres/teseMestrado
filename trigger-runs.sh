...
INTERVAL_SECONDS=${2:-700}     # Seconds to wait between pushes (default: 300)
BRANCH="applications/tooljet" # Branch to push to
...
for i in $(seq 1 "$NUM_RUNS"); do
    ...
    git commit --allow-empty -m "Linux Azure Step Test - $i/$NUM_RUNS"
