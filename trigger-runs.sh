...
INTERVAL_SECONDS=${2:-240}     # Seconds to wait between pushes (default: 400)
BRANCH="applications/directus" # Branch to push to
...
for i in $(seq 1 "$NUM_RUNS"); do
    ...
    git commit --allow-empty -m "MacOS Jenkins Step Test - $i/$NUM_RUNS"
