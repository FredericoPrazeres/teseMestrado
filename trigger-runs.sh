...
NUM_RUNS=${1:-4}              # Number of pipeline runs to trigger (default: 5)
INTERVAL_SECONDS=${2:-300}     # Seconds to wait between pushes (default: 400)
BRANCH="cloudMicroservices" # Branch to push to
...
for i in $(seq 1 "$NUM_RUNS"); do
    ...
    git commit --allow-empty -m "Jenkins Resource Push - $i/$NUM_RUNS"
